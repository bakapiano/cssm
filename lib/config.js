...
function mergeWithDefaults(partial) {
  ...
  if (!Array.isArray(out.repos) || out.repos.length === 0) {
...
module.exports = { loadConfig, saveConfig, DATA_DIR, CONFIG_PATH, DEFAULTS };
